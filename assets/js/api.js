...
const MESSAGES = {
  ...
  invalid_bet: "Такую ставку касса не принимает.",
  invalid_guess: "Выберите «больше» или «меньше».",
  choice_unavailable: "Этот вариант невозможен: подходящих карт не осталось.",
