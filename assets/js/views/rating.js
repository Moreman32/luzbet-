...
export async function mount(root) {
  ...
  root.append(h("div",{class:"container stack"},
    h("div",{class:"rating-head"},
      h("div",{},h("div",{class:"eyebrow"},"Отдел сравнительного унижения"),h("h1",{},"Рейтинг"),h("p",{class:"muted"},"Официальная таблица людей, которые решили превратить виртуальные ЛК в вопрос принципа.")),
      seg),
    h("div",{class:"rating-legend muted"},"Место определяется балансом. При равенстве выше тот, кто убедительнее кормил оборот."),
    body,note,
